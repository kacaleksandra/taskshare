      ...
      <div className='mx-16 mt-14'>
        ...
        <div className='py-10 flex flex-row bg-blue-100 mb-6 rounded-lg'>
          ...
          <div className='flex flex-col items-center justify-center gap-4'>
            <h2 className='text-2xl font-medium text-center'>For teachers</h2>
            <p className='sm:w-2/3 text-center px-2'>
              Are you a teacher? Create <b>repositories</b>, assign <b>tasks</b>
              , and forget about emails with task files.
            </p>
          </div>
        </div>
      </div>
